package com.suguiming.selectphoto_android.photo_lib.customer;
...
public class BorderTextView extends TextView {
    ...
    public BorderTextView(Context context, AttributeSet attrs) {
        ...
        borderColor = array.getColor(R.styleable.BorderTextView_bord_color, 0);
        borderWidth = array.getDimensionPixelSize(R.styleable.BorderTextView_bord_width,
